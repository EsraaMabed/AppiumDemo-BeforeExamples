...
public class HomeTest {
    ...
    public void test_click_Action() {
        ...
        Assert.assertEquals(homepage.clickOnAccessability().getTitle(),"Accessibility Node Provider");
//
    }
    ...
    public void test_typing1() {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        homepage.clickOnAppbutton().clickOnAcivity().clickOnCustomTitle().sendText("Appium");
    ...
    public void testCheckBox() {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        homepage.clickOnAccessability().clickOnQueryButton().clickOnQueryButton();
    ...
    public void testScrolling() {
        ...
        homepage.clickOnGraphicsbutton().scrollDown();
    }
    ...
    public void testSwiping() {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        homepage.clickOnGraphicsbutton().scrollDown1();
    }
    ...
    public void testRadioButton() {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        homepage.clickOnviewsbutton().clickOnRadioPage();
